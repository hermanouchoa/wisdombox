...
mensalAberto.columns = ["mes", "uf", "gasto"]
print(mensalAberto.head())

### Desafio:
###  como criar uma tabela equivalente ao "mensal"" baseada no "mensalAberto"

plt.figure(figsize=(10,6))
axis = sns.lineplot(data=mensalAberto, x="mes", y="gasto",hue="uf")
...
### Desafio
###     Plotar dois estados no mesmo gráfico
###     Escolher uma paleta de cores (pelo menos 27 cores)
###     Formatar legendas e eixos
###     Como configurar o grid com o seaborne