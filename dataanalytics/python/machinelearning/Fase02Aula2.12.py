...
print("correlacao_sentimento")
print(correlacao_sentimento)

sns.heatmap(
    correlacao_sentimento.to_frame(), 
    annot=True, 
    cmap="coolwarm"
    )
...
plt.title("Relação entre valencia média e a caoacidade de dança das músicas")
plt.show()
...
plt.xlabel("media valence")
plt.ylabel("liveness")
plt.title("Relação entre valencia média e  músicas ao vivo")
plt.show()